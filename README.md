...
![equals1](http://latex.codecogs.com/svg.latex?{\color{White}x%20%3A%3D%202kj})
...
![equals2](http://latex.codecogs.com/svg.latex?{\color{White}x%20%3D%202kj})
...
![squareroot](http://latex.codecogs.com/svg.latex?{\color{White}%5Cleft%28%5Csqrt%7Bx%7D%5Cright%29%5E2%20%3D%20x})
...
Complex numbers are expressions of the form ![complex](http://latex.codecogs.com/svg.latex?{\color{White}a&space;&plus;&space;ib}), where ![a](http://latex.codecogs.com/svg.latex?{\color{White}a}) is the real part and ![b](http://latex.codecogs.com/svg.latex?{\color{White}b}) is the imaginary part. The imaginary number ![i](http://latex.codecogs.com/svg.latex?{\color{White}i}) is defined as:

![imaginary](http://latex.codecogs.com/svg.latex?{\color{White}i%3D%5Csqrt%7B-1%7D}).
<!-- i=\sqrt{-1} -->
...
![dotcross1](http://latex.codecogs.com/svg.latex?{\color{White}5%20%5Ccdot%204%20%3D%205%20%5Ctimes%204})
...
![dotcross2](http://latex.codecogs.com/svg.latex?{\color{White}3kj})
...
![dotcross3](http://latex.codecogs.com/svg.latex?{\color{White}3%5Cmathbf%7Bk%7D%5Ccirc%5Cmathbf%7Bj%7D})
...
![dotcross4](http://latex.codecogs.com/svg.latex?{\color{White}%5Cmathbf%7Bk%7D%5Ccdot%20%5Cmathbf%7Bj%7D})
...
![dotcross5](http://latex.codecogs.com/svg.latex?{\color{White}%5Cmathbf%7Bk%7D%5Ctimes%20%5Cmathbf%7Bj%7D})
...
![sigma](http://latex.codecogs.com/svg.latex?{\color{White}%5Csum_%7Bi%3D1%7D%5E%7B100%7Di})
...
![sum2](http://latex.codecogs.com/svg.latex?{\color{White}%5Csum_%7Bi%3D1%7D%5E%7B100%7D%282i&plus;1%29})
...
![sigma3](http://latex.codecogs.com/svg.latex?{\color{White}%5Csum_%7Bi%3D1%7D%5E%7B2%7D%5Csum_%7Bj%3D4%7D%5E%7B6%7D%283ij%29})
...
![capitalPi](http://latex.codecogs.com/svg.latex?{\color{White}%5Cprod_%7Bi%3D1%7D%5E%7B6%7Di})
...
![pipes1](http://latex.codecogs.com/svg.latex?{\color{White}%5Cleft%20%7C%20x%20%5Cright%20%7C})
...
![pipes4](http://latex.codecogs.com/svg.latex?{\color{White}%5Cleft%20%5C%7C%20%5Cmathbf%7Bv%7D%20%5Cright%20%5C%7C})
...
![pipes2](http://latex.codecogs.com/svg.latex?{\color{White}%5Cleft%20%7C%20%5Cmathbf%7Bv%7D%20%5Cright%20%7C})
...
![pipes3](http://latex.codecogs.com/svg.latex?{\color{White}%5Cleft%20%7C%5Cmathbf%7BA%7D%20%5Cright%20%7C})
...
![hat](http://latex.codecogs.com/svg.latex?{\color{White}%5Chat%7B%5Cmathbf%7Ba%7D%7D})
...
![element1](http://latex.codecogs.com/svg.latex?{\color{White}A%3D%5Cleft%20%5C%7B3%2C9%2C14%7D%7B%20%5Cright%20%5C%7D%2C%203%20%5Cin%20A})
...
![element2](http://latex.codecogs.com/svg.latex?{\color{White}A%3D%5Cleft%20%5C%7B3%2C9%2C14%7D%7B%20%5Cright%20%5C%7D%2C%20A%20%5Cni%203})

<!-- A=\left \{3,9,14}{  \right \}, A \ni 3 -->

You can also use the "not an element of" symbols `∉` and `∌` like so:

![element3](http://latex.codecogs.com/svg.latex?{\color{White}A%3D%5Cleft%20%5C%7B3%2C9%2C14%7D%7B%20%5Cright%20%5C%7D%2C%206%20%5Cnotin%20A})
...
![real](http://latex.codecogs.com/svg.latex?{\color{White}k%20%5Cin%20%5Cmathbb%7BR%7D})
...
![function1](http://latex.codecogs.com/svg.latex?{\color{White}x%5E%7B2%7D})

<!-- x^{2} -->

We can give this function a *name*. Commonly, we use `ƒ` to describe a function, but it could be named `A(x)` or anything else.

![function2](http://latex.codecogs.com/svg.latex?{\color{White}f%5Cleft%20%28x%20%5Cright%20%29%20%3D%20x%5E%7B2%7D})
...
![function3](http://latex.codecogs.com/svg.latex?{\color{White}y%20%3D%20x%5E%7B2%7D})
...
![function4](http://latex.codecogs.com/svg.latex?{\color{White}f%28x%2Cy%29%20%3D%20%5Csqrt%7Bx%5E2%20&plus;%20y%5E2%7D})
...
![piecewise1](http://latex.codecogs.com/svg.latex?{\color{White}f%28x%29%3D%20%5Cbegin%7Bcases%7D%20%5Cfrac%7Bx%5E2-x%7D%7Bx%7D%2C%26%20%5Ctext%7Bif%20%7D%20x%5Cgeq%201%5C%5C%200%2C%20%26%20%5Ctext%7Botherwise%7D%20%5Cend%7Bcases%7D})
...
![sgn](http://latex.codecogs.com/svg.latex?{\color{White}sgn%28x%29%20%3A%3D%20%5Cbegin%7Bcases%7D%20-1%26%20%5Ctext%7Bif%20%7D%20x%20%3C%200%5C%5C%200%2C%20%26%20%5Ctext%7Bif%20%7D%20%7Bx%20%3D%200%7D%5C%5C%201%2C%20%26%20%5Ctext%7Bif%20%7D%20x%20%3E%200%5C%5C%20%5Cend%7Bcases%7D})
...
![mapsto](http://latex.codecogs.com/svg.latex?{\color{White}f%20%3A%20x%20%5Cmapsto%20x%5E2})
...
![funcnot](http://latex.codecogs.com/svg.latex?{\color{White}%5Cbegin%7Balign*%7D%20f%20%3A%26%5Cmathbb%7BR%7D%20%5Crightarrow%20%5Cmathbb%7BR%7D%5C%5C%20%26x%20%5Cmapsto%20x%5E2%20%5Cend%7Balign*%7D})
...
![domain2](http://latex.codecogs.com/svg.latex?{\color{White}sgn%20%3A%20%5Cmathbb%7BR%7D%20%5Crightarrow%20%5Cmathbb%7BZ%7D})
...
![prime1](http://latex.codecogs.com/svg.latex?{\color{White}f%27%28x%29%20%3D%202x})
...
![floor](http://latex.codecogs.com/svg.latex?{\color{White}floor%28x%29%20%3D%20%5Clfloor%20x%20%5Crfloor})

<!-- floor(x) =  \lfloor x \rfloor -->

![ceil](http://latex.codecogs.com/svg.latex?{\color{White}ceil%28x%29%20%3D%20%5Clceil%20x%20%5Crceil})
...
![round](http://latex.codecogs.com/svg.latex?{\color{White}round%28x%29%20%3D%20%5Clfloor%20x%20%5Crceil})
...
![material1](http://latex.codecogs.com/svg.latex?{\color{White}A%20%5CRightarrow%20B})
...
![material-equiv](http://latex.codecogs.com/svg.latex?{\color{White}A%20%5CLeftrightarrow%20B})
...
![ngt](http://latex.codecogs.com/svg.latex?{\color{White}k%20%5Cngtr%20j})
...
![orderofmag](http://latex.codecogs.com/svg.latex?{\color{White}k%20%5Cgg%20j})
...
![and](http://latex.codecogs.com/svg.latex?{\color{White}k%20%3E%202%20%5Cland%20k%20%3C%204%20%5CLeftrightarrow%20k%20%3D%203})
...
![logic-or](http://latex.codecogs.com/svg.latex?{\color{White}A%20%5Clor%20B})
...
![negation](http://latex.codecogs.com/svg.latex?{\color{White}x%20%5Cneq%20y%20%5CLeftrightarrow%20%5Clnot%28x%20%3D%20y%29})
...
- Not including zero or one: ![interval-opened-left-opened-right](http://latex.codecogs.com/svg.latex?{\color{White}%280%2C%201%29})

<!-- (0, 1) -->

- Including zero or but not one: ![interval-closed-left-opened-right](http://latex.codecogs.com/svg.latex?{\color{White}%5B0%2C%201%29})

<!-- [0, 1) -->

- Not including zero but including one: ![interval-opened-left-closed-right](http://latex.codecogs.com/svg.latex?{\color{White}%280%2C%201%5D})

<!-- (0, 1] -->

- Including zero and one: ![interval-closed-left-closed-right](http://latex.codecogs.com/svg.latex?{\color{White}%5B0%2C%201%5D})

<!-- [0, 1] -->

For example we to indicate that a point `x` is in the unit cube in 3D we say:

![interval-unit-cube](http://latex.codecogs.com/svg.latex?{\color{White}x%20%5Cin%20%5B0%2C%201%5D%5E3})
...
- *intersection* e.g. ![interval-intersection](http://latex.codecogs.com/svg.latex?{\color{White}%5B3%2C%205%29%20%5Ccap%20%5B4%2C%206%5D%20%3D%20%5B4%2C%205%29})

<!-- [3, 5) \cap [4, 6] = [4, 5) -->

- *union* e.g. ![interval-union](http://latex.codecogs.com/svg.latex?{\color{White}%5B3%2C%205%29%20%5Ccup%20%5B4%2C%206%5D%20%3D%20%5B3%2C%206%5D})

<!-- [3, 5) \cup [4, 6] = [3, 6] -->

- *difference* e.g. ![interval-difference-1](http://latex.codecogs.com/svg.latex?{\color{White}%5B3%2C%205%29%20-%20%5B4%2C%206%5D%20%3D%20%5B3%2C%204%29}) and ![interval-difference-2](http://latex.codecogs.com/svg.latex?{\color{White}%5B4%2C%206%5D%20-%20%5B3%2C%205%29%20%3D%20%5B5%2C%206%5D})
